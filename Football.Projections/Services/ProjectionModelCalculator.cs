...
namespace Football.Projections.Services
{
    public class ProjectionModelCalculator(IFantasyDataService fantasyService, IStatisticsService statisticsService, IStatProjectionCalculator statCalculator, IMatrixCalculator matrixCalculator, IMapper mapper) : IProjectionModelCalculator
    {
        ...
        public async Task<Vector<double>> GetWeeklyWeightedAverageVector(Player player, int currentWeek, WeeklyTunings tunings, List<string>? filter = null, bool neuralNetwork = false)
        {
            ...
            switch (position)
            {
                case Position.QB:
                    ...
                    return neuralNetwork ? matrixCalculator.TransformNeuralNetworkModel(modelQB) : matrixCalculator.TransformModel(modelQB, filter);
                case Position.RB:
                    ...
                    return neuralNetwork ? matrixCalculator.TransformNeuralNetworkModel(modelRB) : matrixCalculator.TransformModel(modelRB, filter);
                case Position.WR:
                    ...
                    return neuralNetwork ? matrixCalculator.TransformNeuralNetworkModel(modelWR) : matrixCalculator.TransformModel(modelWR, filter);
                case Position.TE:
                    ...
                    return neuralNetwork ? matrixCalculator.TransformNeuralNetworkModel(modelTE) : matrixCalculator.TransformModel(modelTE, filter);
                case Position.K:
                    ...
                    return neuralNetwork ? matrixCalculator.TransformNeuralNetworkModel(modelK) : matrixCalculator.TransformModel(modelK, filter);
                case Position.DST:
                    ...
                    return neuralNetwork ? matrixCalculator.TransformNeuralNetworkModel(modelDST) : matrixCalculator.TransformModel(modelDST, filter);
